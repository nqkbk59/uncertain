...
class Dataset:
    def __init__(self, meta=None, filename="res_task_a.csv", winSize=144, horizon=0, resource='cpu',
        ...
        self.samp_time = 2419200  # 29 days in seconds
    ...
    def dataset_creation(self):
        ...
        if self.meta is not None:
            ...
            df['time'] = df[['date']].apply(lambda x: x[0].timestamp(), axis=1).astype(int)
...
h = 2
resources = ['cpu']
ds = Dataset(meta=False, filename='period_12-0005' +  '.csv', horizon=h,
                                 resource='cpu')
